...
import { IconPhone, IconTrash, IconCopy } from "@tabler/icons-react";
...
export function PhoneNumberElement({
  element,
  index,
  selectedId,
  setSelectedId,
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <div className="pt-[5px]">{<IconPhone size={16} />}</div>
              <p className="text-sm font-medium">Phone number input</p>
            </div>
            <div className="flex items-center space-x-2">
