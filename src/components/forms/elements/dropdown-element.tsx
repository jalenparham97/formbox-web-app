    ...
    >
        ...
        <div className="space-y-4">
          <div className="space-y-3">
            <input
              ...
              name="label"
              defaultValue={element?.label || "Untitled question"}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <div className="">{<IconChevronDown size={18} />}</div>
              <p className="text-sm font-medium">Dropdown list</p>
            </div>
            <div className="flex items-center space-x-2">
      ...
      {!isSelected && (
        <div>
          ...
          <Select>
            <SelectTrigger className="pointer-events-none mt-[5px] text-gray-400 disabled:cursor-pointer">
